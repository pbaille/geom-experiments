...
var or__18275__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__19385 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__19385;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__18263__auto__ = id;
...
if(cljs.core.truth_((function (){var or__18275__auto__ = id;
if(cljs.core.truth_(or__18275__auto__)){
return or__18275__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__18873__auto__,writer__18874__auto__,opt__18875__auto__){
return cljs.core._write.call(null,writer__18874__auto__,"hipo.hiccup/Sentinel");
});
...
var G__19387 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__18275__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__18275__auto__)){
return or__18275__auto__;
} else {
...
var G__19389 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__19390 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__19389;
v__$1 = G__19390;
continue;
}
