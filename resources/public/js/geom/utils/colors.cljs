...
(defn palettes-req [w]
  (fn [cb]
    (get-json (str "http://cors.io/?u=http://www.colourlovers.com/api/palettes/" w "?format=json")
...
(defn colors-req [w]
  (fn [cb]
    (get-json (str "http://cors.io/?u=http://www.colourlovers.com/api/colors/" w "?format=json")
              (comp cb colors->map))))
