 ...
 * @implements {thi.ng.geom.core.quaternion.Object}
...
thi.ng.geom.core.quaternion.Quat4.prototype.thi$ng$geom$core$PVectorTransform$transform_vector$arity$2 = (function (_,p__22482){
var self__ = this;
var vec__22483 = p__22482;
var vx = cljs.core.nth.call(null,vec__22483,(0),null);
var vy = cljs.core.nth.call(null,vec__22483,(1),null);
var vz = cljs.core.nth.call(null,vec__22483,(2),null);
var v = vec__22483;
var ___$1 = this;
...
var self__ = this;
var ___$1 = this;
var vec__22488 = new cljs.core.Keyword(null,"translate","translate",1336199447).cljs$core$IFn$_invoke$arity$1(opts);
var tx = cljs.core.nth.call(null,vec__22488,(0),null);
var ty = cljs.core.nth.call(null,vec__22488,(1),null);
var tz = cljs.core.nth.call(null,vec__22488,(2),null);
...
var wy = (self__.w * y2);
var wz = (self__.w * z2);
return (new thi.ng.geom.core.matrix.Matrix44((1.0 - (yy + zz)),(xy + wz),(xz - wy),0.0,(xy - wz),(1.0 - (xx + zz)),(yz + wx),0.0,(xz + wy),(yz - wx),(1.0 - (xx + yy)),0.0,(function (){var or__18275__auto__ = tx;
if(cljs.core.truth_(or__18275__auto__)){
return or__18275__auto__;
} else {
return 0.0;
}
})(),(function (){var or__18275__auto__ = ty;
if(cljs.core.truth_(or__18275__auto__)){
return or__18275__auto__;
} else {
return 0.0;
}
})(),(function (){var or__18275__auto__ = tz;
if(cljs.core.truth_(or__18275__auto__)){
return or__18275__auto__;
} else {
return 0.0;
...
var G__22492 = null;
var G__22492__2 = (function (self__,k){
var self__ = this;
var self____$1 = this;
var _ = self____$1;
return thi.ng.geom.core.quaternion.swizzle4.call(null,_,k,null);
});
var G__22492__3 = (function (self__,k,nf){
var self__ = this;
var self____$1 = this;
var _ = self____$1;
return thi.ng.geom.core.quaternion.swizzle4.call(null,_,k,nf);
});
G__22492 = function(self__,k,nf){
switch(arguments.length){
case 2:
return G__22492__2.call(this,self__,k);
case 3:
return G__22492__3.call(this,self__,k,nf);
}
...
thi.ng.geom.core.quaternion.Quat4.prototype.apply = (function (self__,args22481){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args22481)));
});
...
thi.ng.geom.core.quaternion.Quat4.prototype.thi$ng$math$core$PDeltaEquals$ = true;
...
var self__ = this;
var ___$1 = this;
var and__18263__auto__ = cljs.core.sequential_QMARK_.call(null,q);
if(and__18263__auto__){
var and__18263__auto____$1 = ((4) === cljs.core.count.call(null,q));
if(and__18263__auto____$1){
var and__18263__auto____$2 = thi.ng.math.core.delta_EQ_.call(null,self__.x,cljs.core.first.call(null,q),eps);
if(cljs.core.truth_(and__18263__auto____$2)){
var and__18263__auto____$3 = thi.ng.math.core.delta_EQ_.call(null,self__.y,cljs.core.nth.call(null,q,(1)),eps);
if(cljs.core.truth_(and__18263__auto____$3)){
var and__18263__auto____$4 = thi.ng.math.core.delta_EQ_.call(null,self__.z,cljs.core.nth.call(null,q,(2)),eps);
...
if((thi.ng.math.core.abs.call(null,d) < 1.0)){
var theta = Math.acos(d);
var stheta = Math.sqrt(((d * (- d)) + 1.0));
var vec__22487 = (((thi.ng.math.core.abs.call(null,stheta) < 0.001))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.5,0.5], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(Math.sin(((1.0 - t) * theta)) / stheta),(Math.sin((t * theta)) / stheta)], null));
...
thi.ng.geom.core.quaternion.Quat4.cljs$lang$ctorPrWriter = (function (this__18873__auto__,writer__18874__auto__,opt__18875__auto__){
return cljs.core._write.call(null,writer__18874__auto__,"thi.ng.geom.core.quaternion/Quat4");
});
...
var args22493 = [];
var len__19333__auto___22500 = arguments.length;
var i__19334__auto___22501 = (0);
while(true){
if((i__19334__auto___22501 < len__19333__auto___22500)){
args22493.push((arguments[i__19334__auto___22501]));

var G__22502 = (i__19334__auto___22501 + (1));
i__19334__auto___22501 = G__22502;
continue;
} else {
}
break;
...
thi.ng.geom.core.quaternion.quat.cljs$core$IFn$_invoke$arity$2 = (function (p__22496,w){
var vec__22497 = p__22496;
var x = cljs.core.nth.call(null,vec__22497,(0),null);
var y = cljs.core.nth.call(null,vec__22497,(1),null);
var z = cljs.core.nth.call(null,vec__22497,(2),null);
return (new thi.ng.geom.core.quaternion.Quat4(x,y,z,w,(-1)));
});

thi.ng.geom.core.quaternion.quat.cljs$core$IFn$_invoke$arity$1 = (function (p__22498){
var vec__22499 = p__22498;
var x = cljs.core.nth.call(null,vec__22499,(0),null);
var y = cljs.core.nth.call(null,vec__22499,(1),null);
var z = cljs.core.nth.call(null,vec__22499,(2),null);
var w = cljs.core.nth.call(null,vec__22499,(3),null);
return (new thi.ng.geom.core.quaternion.Quat4(x,y,z,w,(-1)));
});
...
var vec__22505 = thi.ng.geom.core.normalize.call(null,q);
var x = cljs.core.nth.call(null,vec__22505,(0),null);
var y = cljs.core.nth.call(null,vec__22505,(1),null);
var z = cljs.core.nth.call(null,vec__22505,(2),null);
var w = cljs.core.nth.call(null,vec__22505,(3),null);
...
var vec__22508 = (function (){var G__22509 = (((order instanceof cljs.core.Keyword))?order.fqn:null);
switch (G__22509) {
case "xyz":
...
var a = cljs.core.nth.call(null,vec__22508,(0),null);
var b = cljs.core.nth.call(null,vec__22508,(1),null);
var c = cljs.core.nth.call(null,vec__22508,(2),null);
...
var G__22518 = (((k instanceof cljs.core.Keyword))?k.fqn:null);
switch (G__22518) {
case "x":
return _.x;
...
var G__22523 = cljs.core.assoc.call(null,acc,keymap.call(null,cljs.core.first.call(null,n__$1)),v.call(null,i));
var G__22524 = (i + (1));
var G__22525 = cljs.core.next.call(null,n__$1);
acc = G__22523;
i = G__22524;
n__$1 = G__22525;
continue;
...
var G__22529 = (((k instanceof cljs.core.Keyword))?k.fqn:null);
switch (G__22529) {
case "x":
return (new thi.ng.geom.core.quaternion.Quat4(v,_.y,_.z,_.w,(-1)));
